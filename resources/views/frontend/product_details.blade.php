                ...
                <div class="col-lg-6">
                    <div class="s_Product_carousel">
                        ...
                        <div class="single-prd-item">
                            <img  style="object-fit: cover;" class="img-fluid" src="{{asset('storage/'. $image->image)}}" alt="">
                        </div>
                            @endforeach
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <div class="card_area d-flex align-items-center">
                            <a class="primary-btn addToCart" data-id="{{$product->id}}" href="javascript:;">Thêm vào giỏ hàng</a>
